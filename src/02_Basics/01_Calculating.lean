...
calc
  ...
  ... = a * a + 2 * (a * b) + b * b     : by rw [mul_comm b, two_mul]
end
...
calc
  (a + b) * (c + d)
      = a * c + a * d + b * c + b * d : by rw [add_mul, mul_add, mul_add, ←add_assoc]
end

example (a b : ℝ) : (a + b) * (a - b) = a^2 - b^2 :=
begin
  rw [add_mul, mul_sub, mul_sub, add_sub],
  rw [←sub_zero (a * b), mul_comm b, ←sub_add, ←sub_self (a * b), add_sub],
  rw [sub_add, sub_add, sub_self, sub_zero, sub_zero],
  rw [pow_two, pow_two],
end
